...
public class TestHttpServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter().print("<h1>New SET request</h1>");
        resp.getWriter().printf("<h2>New SET request with parameters param 1= %s; param 2 = %s</h2>",
                req.getParameter("param1"),
                req.getParameter("param2"));
//        getServletContext().getRequestDispatcher("/base_servlet")
//                .forward(req, resp);
    }
